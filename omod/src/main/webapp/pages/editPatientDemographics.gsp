<%
	...
	if (!returnUrl) {
		returnUrl = "/${contextPath}/registration/patientdashboard/patientDashboard.page?patientId=${patient.patientId}"
	}
%>
...
<script type="text/javascript">
    var breadcrumbs = [
        ...
        { label: "${ ui.message("registration.editPatientDemographics.label") }", link: "${ ui.pageLink("registration", "editPatientDemographics") }" }
    ];
</script>

<div id="content" class="container">
    <h2>
        ${ ui.message("registration.editPatientDemographics.label") }
    </h2>
    ...
    <form class="simple-form-ui" method="POST">
        ...
        <section id="demographics">
            ...
            <fieldset>
                ...
                ${ ui.includeFragment("uicommons", "field/radioButtons", [
                        label: ui.message("registration.patient.gender.question"),
            ...
            <fieldset class="multiple-input-date no-future-date">
                <legend>${ui.message("registration.patient.birthdate.label")}</legend>
        ...
        <div id="confirmation">
            ...
            <div id="confirmationQuestion">
                Confirm submission? <p style="display: inline"><input type="submit" class="confirm right" value="${ui.message("registration.patient.confirm.label")}" /></p><p style="display: inline"><input id="cancelSubmission" class="cancel" type="button" value="${ui.message("registration.cancel")}" /></p>
            </div>
        </div>
    </form>
</div>
