...
public class RegisterPatientPageController {
    ...
    private static final String REGISTRATION_SECTION_EXTENSION_POINT = "org.openmrs.module.registration.section";
    ...
    public String post(UiSessionContext sessionContext, PageModel model, @RequestParam("appId") AppDescriptor app,
        ...
        InfoErrorMessageUtil.flashInfoMessage(request.getSession(), ui.message("registration.createdPatientMessage", patient.getPersonName()));
