...
@PrepareForTest({ Context.class, RegistrationUiUtils.class, InfoErrorMessageUtil.class })
public class EditPatientContactInfoPageControllerTest {
	...
	public void setup() throws Exception {
		...
		PowerMockito.spy(RegistrationUiUtils.class);
		PowerMockito.doNothing().when(RegistrationUiUtils.class);
		RegistrationUiUtils.validateLatitudeAndLongitudeIfNecessary(Mockito.any(PersonAddress.class),
